...
_C.AUG.RANDOM_OCCLUSION = CN()
_C.AUG.RANDOM_OCCLUSION.ENABLE = False           # 是否开启随机遮挡
_C.AUG.RANDOM_OCCLUSION.NUM_BLOCKS = 1           # 遮挡块个数
_C.AUG.RANDOM_OCCLUSION.BLOCK_SIZE = 32          # 遮挡块大小
_C.AUG.RANDOM_OCCLUSION.PROB = 0.3               # 应用遮挡的概率
_C.AUG.LMA = CN()
_C.AUG.LMA.ENABLE = False     # 开关：true 开启三级扰动
_C.AUG.LMA.LAMBDA = 0.5       # λ_cons  一致性 KL 损失权重
# -----------------------------------------------------------------------------
# Testing settings
# -----------------------------------------------------------------------------
_C.TEST = CN()
